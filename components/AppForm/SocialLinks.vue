<template>
  ...
  >
    <div class="shadow sm:overflow-hidden sm:rounded-md">
      <div class="grid grid-cols-2 gap-8 px-4 py-5 sm:p-6">
        <div>
          <label for="facebook" class="block text-sm font-medium text-slate-200"
            >Facebook</label
          >
          <div class="mt-1 flex rounded-md shadow-sm">
            <span
              class="inline-flex items-center rounded-l-md border border-r-0 border-[#723456] bg-[#c198ab] px-3 text-sm text-slate-200"
            >
        ...
        <div>
          <label for="twitter" class="block text-sm font-medium text-slate-200"
            >Twitter</label
          >
          <div class="mt-1 flex rounded-md shadow-sm">
            <span
              class="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-[#c198ab] px-3 text-sm text-slate-200"
            >
        ...
        <div>
          <label for="instagram" class="block text-sm font-medium text-slate-200"
            >Instagram</label
          >
          <div class="mt-1 flex rounded-md shadow-sm">
            <span
